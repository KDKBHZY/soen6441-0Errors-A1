...
public class WordstatsActorTest {
    ...
    public void testWordstatsActor() {
        new TestKit(system) {{
            ...
            final Props propsSra = Props.create(WordstatsResultActor.class);
            final TestActorRef<WordstatsResultActor> subjectSra = TestActorRef.create(system, propsSra, "testB");
            final WordstatsResultActor wordstatsActorSync = subjectSra.underlyingActor();
            ...
            wordstatsActor.setWordstatsActors(searchResultsActorsMap);
    ...
    public void setSearchResultsActors() {
        wordstatsActor.setWordstatsActors(null);
        Assert.assertNull(wordstatsActor.getWordstatsActors());
    }
