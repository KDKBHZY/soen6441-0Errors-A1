...
public class WordstatsResultActorTest {
    ...
    public void testWordstatsResultActor() {
        new TestKit(system) {{
            ...
            final Props props = Props.create(WordstatsResultActor.class);
            ...
            within(duration("3 seconds"), () -> {
                subject.tell(new Messages.WatchwordstatsResults("nba"), getRef());

                // response must have been enqueued to us before probe
                expectMsgClass(duration("3 seconds"), Messages.WordstatsMessage.class);
                return null;
            });
